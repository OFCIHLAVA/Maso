...
class ItemLine(CTkFrame):
    ...
    def __init__(self, master=None, item_data_dict=None, footer=None, **kwargs):
        super().__init__(master=master, fg_color="grey", **kwargs)
        ...
        self.id_label = CTkLabel(self, width=40, height=5, text=self.id, font=("roboto", 12, "bold"), pady=10, padx=10, corner_radius=3)
        self.id_label.pack(side="left", padx=5, fill="x")
        ...
        self.icon_label.pack(side="left", padx=5, fill="x")
        ...
        self.on_stock_label.pack(side="left", padx=5, fill="x")
