...
class SellBar(customtkinter.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        # Storno button
        self.storno_button = customtkinter.CTkButton(self, height=70, text="STORNO", fg_color="red")
        self.storno_button.pack(side="left", fill="x", padx=10, pady=10, expand=True)
        # K pokladne button
        self.to_checkout_button = customtkinter.CTkButton(self, height=70, text="TO CHECKOUT", fg_color="green")
